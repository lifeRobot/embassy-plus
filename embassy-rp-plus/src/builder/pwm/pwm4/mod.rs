...
impl<'d> Pwm4Builder<'d> {
    ...
    #[inline]
    pub fn output_a(self, a: Pwm4A<'d>) -> Pwm<'d> {
        match a {
    ...
    #[inline]
    pub fn output_b(self, b: Pwm4B<'d>) -> Pwm<'d> {
        match b {
    ...
    #[inline]
    pub fn output_ab(self, a: Pwm4A<'d>, b: Pwm4B<'d>) -> Pwm<'d> {
        match a {
    ...
    #[inline]
    fn build_b(self, a: Peri<'d, impl ChannelAPin<PWM_SLICE4>>, b: Pwm4B<'d>) -> Pwm<'d> {
        match b {
    ...
    #[inline]
    pub fn input(self, b: Pwm4B<'d>, pull: Pull, mode: InputMode) -> Pwm<'d> {
        match b {
    ...
    #[inline]
    pub fn output_input(self, a: Pwm4A<'d>, b: Pwm4B<'d>, pull: Pull, mode: InputMode) -> Pwm<'d> {
        match a {
    ...
    #[inline]
    fn input_b(self, a: Peri<'d, impl ChannelAPin<PWM_SLICE4>>, b: Pwm4B<'d>, pull: Pull, mode: InputMode) -> Pwm<'d> {
        match b {
